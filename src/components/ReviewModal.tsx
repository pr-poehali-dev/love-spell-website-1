  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 transition-all duration-300 ${
      ...
      <div className={`relative w-full max-w-sm sm:max-w-md bg-card rounded-2xl sm:rounded-3xl shadow-2xl border border-border transition-all duration-300 transform max-h-[95vh] overflow-y-auto ${
        ...
        <button
          onClick={handleClose}
          className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-accent/10 rounded-full transition-all duration-200 z-10"
        >
          <Icon name="X" size={20} />
        </button>
          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="text-center mb-8">
                <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-accent via-accent/90 to-accent/80 rounded-2xl flex items-center justify-center shadow-lg">
                  <Icon name="MessageSquare" size={24} className="text-background" />
                  <Icon name="Plus" size={16} className="text-background -ml-2 -mt-2" />
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-accent/5 border-2 rounded-xl text-foreground placeholder-muted-foreground focus:outline-none transition-all duration-200 ${
                      errors.name 
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className={`w-full px-4 py-3 bg-accent/5 border-2 rounded-xl text-foreground placeholder-muted-foreground focus:outline-none transition-all duration-200 resize-none ${
                      errors.review 
                        ? 'border-red-500 focus:border-red-400' 
                        : 'border-accent/20 focus:border-accent'
                    }`}
