            ...
            <div className="space-y-4">
              <div>
                ...
                {topicSuggestions.length > 0 ? (
                  ...
                  <div className="mt-2 p-4 border-2 border-dashed border-muted-foreground/20 rounded-lg text-center">
                    <Icon name="Plus" size={20} className="text-muted-foreground mx-auto mb-2" />
                    <p className="text-sm text-muted-foreground">
                      Добавьте темы для статей в поле ниже
                    </p>
                  </div>
                )}
              ...
              <div>
                <Label>Добавить тему статьи</Label>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Нажмите Enter или кнопку "Добавить" для добавления темы
                </p>
              </div>
            </div>
          </div>
