        ...
        {faqItems.map((question, index) => {
          ...
          return (
            <div key={index} className="group relative overflow-hidden">
              ...
              >
                {/* Множественные хаотичные иконки вопросов слева */}
                <div className="absolute inset-0 overflow-hidden select-none pointer-events-none">
                  {/* Основная иконка - левый верх */}
                  <div 
                    className="absolute left-2 top-4 w-8 h-8 rounded-md flex items-center justify-center transition-all duration-300 transform rotate-12" 
                    style={{
                  ...
                  <div 
                    className="absolute left-1 top-12 w-6 h-6 rounded flex items-center justify-center transform -rotate-45" 
                    style={{
                  ...
                  <div 
                    className="absolute left-1 bottom-2 w-5 h-5 rounded flex items-center justify-center transform rotate-45" 
                    style={{
                  ...
                  <div 
                    className="absolute left-6 bottom-4 w-7 h-7 rounded-lg flex items-center justify-center transform rotate-75" 
                    style={{
                  ...
                  <div 
                    className="absolute left-8 top-1/2 w-6 h-6 rounded flex items-center justify-center transform -rotate-30" 
                    style={{
