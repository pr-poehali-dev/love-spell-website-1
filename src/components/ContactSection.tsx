      ...
      <div className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mx-auto px-4 sm:px-6 py-2 sm:py-4 space-y-12 sm:space-y-16">
        ...
        <div className="flex justify-center mb-8">
          <div className="relative w-full max-w-sm px-2 xs:px-4">
            ...
            >
              {/* Контент - адаптивный */}
              <div className="flex flex-col items-start justify-center gap-0 xs:gap-0.5 min-w-0 flex-1">
                ...
                <div className="text-white text-sm xs:text-base sm:text-lg font-bold truncate w-full">
                  Напишите мне
                </div>
              </div>
            </button>
            
            {/* Аватар слева - смещен еще левее с белой обводкой */}
            <div className="absolute left-1 xs:left-2 top-1/2 transform -translate-y-1/2 z-10">
              <div className="relative">
                <div className="w-12 h-12 xs:w-14 xs:h-14 rounded-full overflow-hidden border-2 xs:border-3 border-white bg-white flex-shrink-0">
                  <img 
                ...
                {/* Иконка сообщения */}
                <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 xs:w-5 xs:h-5 bg-white rounded-full flex items-center justify-center shadow-sm">
                  <div className="w-3 h-3 xs:w-3.5 xs:h-3.5 bg-green-500 rounded-full flex items-center justify-center">
